...
const AddRestaurantForum = () => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      const restaurant = { name, city, address, phone ,email, description, rating, category, priceRange, menu, openingTime, closingTime, daysOpen };
  
      axios.post('http://localhost:3040/tours/create_restaurant',restaurant)
        .then(() => {
           // history.push('/')
